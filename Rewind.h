...
private:
	...
	const FVector m_arrTrackedLocation[s_ui16TRACKED_VALUES_SIZE]; // Vector array that tracks the position of the parent object.	
	const FQuat m_arrTrackedRotation[s_ui16TRACKED_VALUES_SIZE]; // Quaterion array that tracks the rotation of the parent object.	
	const FVector m_arrTrackedLinearVelocity[s_ui16TRACKED_VALUES_SIZE];
	const FVector m_arrTrackedAngularVelocity[s_ui16TRACKED_VALUES_SIZE];
};
